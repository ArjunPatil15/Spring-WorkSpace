	...
	public static void main( String[] args )
	{
		...
		do {
			...
			case 4:
				...
				System.out.print("Enter First Name : ");
				s3.setFirstName(scanner.next());
//				firstName =  scanner.next();
				System.out.print("Enter Last Name : ");
				s3.setLastName(scanner.next());
//				lastName = scanner.next();
				System.out.print("Enter City : ");
				s3.setCity(scanner.next());
//				city = scanner.next();
					
				
				result = studentDao.updateOneStudent(s3);
			...
			case 5:
				...
				result = studentDao.deleteOneStudent(s4);
